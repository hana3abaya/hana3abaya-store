(function () {
  ...
  function render() {
    ...
    root.innerHTML =
      ...
      '<p class="checkout-note">بعد تأكيد الطلب يُحفظ مباشرة لدى المتجر، وستصلكِ رسالة تأكيد على واتساب من فريق هنا عباية. طريقة الدفع: <strong>الدفع عند الاستلام</strong>. للدعم: <strong data-wa-display>01010000533</strong></p>' +
